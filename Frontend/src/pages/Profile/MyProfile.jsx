...
const MyProfile = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        if (!profile.id) {
            setError({
                status: null,
                message: "User ID not found. Update cannot be performed.",
            });
            return;
        }
        ...
        try {
            ...
            if (profile.username !== originalUsername) {
                alert("Your session will be logged out because the username has changed.");
                logout();
                return;
            }
            ...
            setError({
                ...
                message: err.response?.data?.message || "Profile could not be updated.",
    ...
    if (!user) {
        return <div style={styles.loading}>Profile loading...</div>;
    }
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.card}>
                {photoLoading && <p style={styles.loading}>Photo loading...</p>}
